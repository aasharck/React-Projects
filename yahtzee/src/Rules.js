...
const threeOfKind = new SumDistro({ count: 3, description: "Sum of all dice if 3 are the same" });
const fourOfKind = new SumDistro({ count: 4, description: "Sum of all the dice if 4 are the same" });

// full house scores as flat 25
const fullHouse = new FullHouse({ score: 25, description: "25 points for fullhouse" });
